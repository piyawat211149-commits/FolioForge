            ...
            {[
              ...
              <div key={field.name} className={field.delay}>
                ...
                <div className="relative">
                  <input
                    name={field.name}
                    type={field.name === "password" ? (showPw ? "text" : "password") : field.type}
                    value={form[field.name as keyof typeof form]}
                    onChange={handleChange}
                    required
                    className={`input-float w-full border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3.5 ${field.name === "password" ? "pr-12" : ""} text-sm text-gray-900 dark:text-white placeholder-gray-300 dark:placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-white/5 transition-colors`}
                  ...
                  {field.name === "password" && (
                    <button
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-gray-400 dark:text-gray-500 hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors"
                      tabIndex={-1}
                    >
                      {showPw ? (
