            ...
            <div className="animate-slide-in-d2">
              ...
              <div className="relative">
                <input
                  ...
                  className="input-focus w-full border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3.5 pr-12 text-sm text-gray-900 dark:text-white placeholder-gray-300 dark:placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-white/5 transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
