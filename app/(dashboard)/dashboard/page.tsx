          ...
          {[
            {
              ...
              url: "https://www.canva.com/design/DAHNOj5J-OU/edit",
            },
            {
              icon: "📝",
              title: "Portfolio แบบ 2",
              desc: "เอกสารอีกแบบ",
              color: "from-emerald-500 to-teal-500",
              shadow: "shadow-emerald-500/20",
              url: "https://www.canva.com/design/DAHNOtMrrd0/edit",
            },
            {
              icon: "🎤",
              title: "Presentation 10 สไลด์",
              desc: "สไลด์นำเสนอสัมภาษณ์",
              color: "from-violet-500 to-purple-500",
              shadow: "shadow-violet-500/20",
              url: "https://www.canva.com/design/DAHNOkLwRFE/edit",
            },
          ].map((item) => (
            <a
              key={item.title}
